export const commandReact = "npm create vite@latest my-app -- --template react-ts";
export const commandVue = "npm create vue@latest";
export const getUsersCommands = (logger) => {
...
//# sourceMappingURL=Commads.Logger.js.map